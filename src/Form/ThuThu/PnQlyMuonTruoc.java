...
public class PnQlyMuonTruoc extends javax.swing.JPanel {
    ...
    public void layMaPhieu(){
        ...
        try {
           ...
           PreparedStatement command=ketNoi.prepareStatement("{call SP_LOAD_MA (?)}");
            //cung cap gia tri cho bien
           command.setString(1, "2");
           ResultSet rs = command.executeQuery();
           // duyet ket qua
           if (rs.next()) {
               maPhieuMuonTruoc=rs.getString(1);
           }
       } catch (Exception e) {
       }
    }
    ...
    private void initComponents() {
        ...
        jLabel_tenDG1 = new javax.swing.JLabel();
        ...
        jLabel_tenDG1.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jLabel_tenDG1.setText("Lù Vĩnh Trường");
        add(jLabel_tenDG1);
        jLabel_tenDG1.setBounds(1010, 130, 150, 19);

        jButton1.setBackground(new java.awt.Color(255, 153, 51));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/more_details_35px.png"))); // NOI18N
        jButton1.setText("Xem Chi tiết");
        add(jButton1);
        jButton1.setBounds(690, 190, 150, 40);

        jButton2.setBackground(new java.awt.Color(255, 51, 51));
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/cancel_subscription_35px.png"))); // NOI18N
        jButton2.setText("Hủy Phiếu");
        add(jButton2);
        jButton2.setBounds(1010, 190, 130, 40);

        jButton3.setBackground(new java.awt.Color(51, 255, 51));
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/check_file_35px.png"))); // NOI18N
        jButton3.setText("Duyệt phiếu");
        add(jButton3);
        jButton3.setBounds(850, 190, 150, 40);
    ...
    private javax.swing.JLabel jLabel_tenDG1;
