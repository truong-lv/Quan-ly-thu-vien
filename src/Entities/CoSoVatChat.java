...
public class CoSoVatChat {
    ...
    public static boolean insert(String tenCSVC, float gia, String maLoaiCSVC, Date ngaySanXuat, int trangThai) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        DBAccess dba = new DBAccess();
        String query = "INSERT INTO CoSoVatChat VALUES(N'" + dba.generateId("7") + "', N'" + tenCSVC + "', N'" + gia + "', N'" + maLoaiCSVC + "', N'" + dateFormat.format(ngaySanXuat) + "', N'" + trangThai + "')";
